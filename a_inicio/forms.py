...
class ClienteForm(forms.Form):
    ...
    video_file = forms.FileField(label='Video de 6 segundos máximo (Opcional)', required=False)
    image_portada1 = forms.ImageField(label='Foto principal (requerida)')
    image1 = forms.ImageField(label='Foto 1 (Requerida)', required=True)
    image2 = forms.ImageField(label='Foto 2 (Requerida)', required=True)
    image3 = forms.ImageField(label='Foto 3 (Requerida)', required=True)
    image4 = forms.ImageField(label='Foto 4 (opcional)', required=False)
    image5 = forms.ImageField(label='Foto 5 (opcional)', required=False)
    image6 = forms.ImageField(label='Foto 6 (opcional)', required=False)
    image7 = forms.ImageField(label='Foto 7 (opcional)', required=False)
    image8 = forms.ImageField(label='Foto 8 (opcional)', required=False)
    image9 = forms.ImageField(label='Foto 9 (opcional)', required=False)
    image10 = forms.ImageField(label='Foto 10 (opcional)', required=False)
